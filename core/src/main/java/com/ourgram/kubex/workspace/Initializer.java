...
public final class Initializer {
    ...
    public InitResult initialize(Path gameRoot, InitMode mode) {
        ...
        try {
            ...
            return new InitResult(true, workspaceRoot, mode, "Initialized KubeX workspace");
        } catch (IOException exception) {
            return new InitResult(false, workspaceRoot, mode, exception.getMessage());
        }
    }
    ...
    private void writeEntryIfMissing(Path scriptsRoot, InitMode mode, String resourcePath) throws IOException {
    ...
    private String templatePath(InitMode mode, String baseName) {
        String folder = mode == InitMode.TS ? "ts" : "js";
        String extension = mode == InitMode.TS ? ".ts" : ".js";
